...
# ---------------------------------------------------------------------------
# CF_STRIP_G_OPT version: 3 updated: 2002/12/21 19:25:52
# --------------
#	Remove "-g" option from the compiler options
AC_DEFUN([CF_STRIP_G_OPT],[
    $1=`echo ${$1} | sed -e 's%-g %%' -e 's%-g$%%'`
])
# ---------------------------------------------------------------------------
# CF_STRIP_O_OPT version: 3 updated: 2001/02/02 19:06:08
# --------------
#	Remove "-O" option from the compiler options
